...
! function(e) {
    ...
    e.Agegate = function(e) {
            ...
            createPopup: function() {
                this.container = document.createElement("div"), this.container.innerHTML = ['<div class="popup-backdrop" style="z-index: 1031; position: fixed; top: 0; right: 0; left: 0; bottom: 0; background-color: #242629; opacity: 0.78; overflow-x: hidden; overflow-y: auto;"></div>', '<div class="popup-modal" style="z-index: 1032; position: fixed; top: 0; right: 0; left: 0; bottom: 0; padding: 10px;">', '<div class="popup-container">', '<div class="popup-body">', this.options.body, "</div>", '<div class="popup-actions">', '<button class="popup-btn popup-agree">', this.options.yesButton, '</button>', '<button class="popup-btn popup-cancel">', this.options.noButton, '</button>', "</div>", "</div>", "</div>"].join(""), document.body.insertBefore(this.container, document.body.firstChild), this.agreeBtn = this.container.querySelector(".popup-agree"), this.cancelBtn = this.container.querySelector(".popup-cancel")
            },
